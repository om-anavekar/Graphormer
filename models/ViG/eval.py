# # Code modified from ViG repo & LeViT repo

import os
import sys
sys.path.insert(0, os.path.abspath("Efficient-AI-Backbones/vig_pytorch"))
...
def main():
    ...
    eval_dir = imagenet_path #os.path.join(args.data, 'val')
...
# import sys
# sys.path.insert(0, os.path.abspath("Efficient-AI-Backbones/vig_pytorch"))
# # sys.path.insert(0, os.path.abspath("/afs/ece.cmu.edu/usr/pvenkatr/Private/IDL/Graphormer/models/LeVit/"))
...
# imagenet_path = "/scratch/graphormer_imagenet/imagenet/val/"
# pretrain_path = "/scratch/vig_ckpts/" + "vig_ti_74.5.pth" #vig_b_82.6.pth  vig_s_80.6.pth  vig_ti_74.5.pth
# device = "cuda"
